...
class TokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create token" do
    assert_difference('Token.count') do
      post tokens_url, params: { token: { list_id: @token.list_id, name: @token.name, value: @token.value } }
    end
  ...
  test "should update token" do
    patch token_url(@token), params: { token: { list_id: @token.list_id, name: @token.name, value: @token.value } }
